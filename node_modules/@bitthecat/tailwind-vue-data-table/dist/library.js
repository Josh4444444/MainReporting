...
const totPages = vue.ref(Math.ceil(props.totalRows/props.perPage));
...
vue.watch(() => props.totalRows, (value) => {
...
return (_ctx, _cache) => {
  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [
    ...
    vue.createElementVNode("div", _hoisted_8$1, [
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(pages), (page) => {
        return (vue.openBlock(), vue.createElementBlock("p", {
          key: `page_${page}`,
          class: vue.normalizeClass(["text-sm font-medium leading-none cursor-pointer link px-2", paginationClass(page)]),
          onClick: $event => (changePage(page))
        }, vue.toDisplayString(page), 11 /* TEXT, CLASS, PROPS */, _hoisted_9$1))
      }), 128 /* KEYED_FRAGMENT */))
    ]),
...
const _hoisted_13 = /*#__PURE__*/vue.createElementVNode("path", {
  "stroke-linecap": "round",
  "stroke-linejoin": "round",
...
const _hoisted_19 = /*#__PURE__*/vue.createElementVNode("circle", {
  class: "opacity-25",
  cx: "12",
  cy: "12",
  r: "10",
...
const _hoisted_20 = /*#__PURE__*/vue.createElementVNode("path", {
  class: "opacity-75",
  fill: "currentColor",
...
const localTotalRows = vue.computed(() => {
    return props.totalRows || props.items.length || 0
});

const fromRow = vue.ref(0);
const toRow = vue.ref(0);
const localCurrentPage = vue.ref(props.currentPage);
...
vue.watch(() => localCurrentPage.value, (value) => {
    refreshCounter();
  ...
  return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
    (!__props.hidePagination && __props.totalRows != 0)
      ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
          vue.createElementVNode("span", null, "Displaying " + vue.toDisplayString(fromRow.value + 1) + " to " + vue.toDisplayString(toRow.value) + " of " + vue.toDisplayString(__props.totalRows) + " items", 1 /* TEXT */)
        ]))
      : vue.createCommentVNode("v-if", true),
    vue.createElementVNode("div", _hoisted_2, [
      vue.createElementVNode("table", _hoisted_3, [
        vue.createElementVNode("thead", _hoisted_4, [
          (vue.unref(slots)['header-row'])
            ? vue.renderSlot(_ctx.$slots, "header-row", { key: 0 })
            : vue.createCommentVNode("v-if", true),
          vue.createElementVNode("tr", _hoisted_5, [
            (__props.enableCheck)
              ? (vue.openBlock(), vue.createElementBlock("th", _hoisted_6))
              : vue.createCommentVNode("v-if", true),
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.fields, (field) => {
              return (vue.openBlock(), vue.createElementBlock("th", {
                key: field.label,
                class: vue.normalizeClass(["px-2 py-1.5 font-medium uppercase", field.thClass]),
                style: vue.normalizeStyle(field.thStyle)
              }, [
                vue.createElementVNode("div", _hoisted_7, [
                  vue.createElementVNode("span", null, vue.toDisplayString(field.label), 1 /* TEXT */),
                  (field.sortable)
        ...
        vue.createElementVNode("tbody", _hoisted_15, [
          (__props.busy)
            ? (vue.openBlock(), vue.createElementBlock("tr", _hoisted_16, [
                vue.createElementVNode("td", {
                  colspan: __props.enableCheck ? __props.fields.length + 1 : __props.fields.length
                }, [
                  vue.createElementVNode("div", _hoisted_18, [
                    vue.renderSlot(_ctx.$slots, "busy", {}, () => [
                      (vue.openBlock(), vue.createElementBlock("svg", {
                        class: vue.normalizeClass(["animate-spin -ml-1 mr-3 h-6 w-6 text-black", __props.spinnerClass]),
                        xmlns: "http://www.w3.org/2000/svg",
                        fill: "none",
                        viewBox: "0 0 24 24"
                      }, _hoisted_21, 2 /* CLASS */))
            ...
            : (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 1 }, vue.renderList(__props.items, (item, index) => {
                return (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                  key: item.id
                }, [
                  vue.createElementVNode("tr", {
                    id: `TVTABLE_row_${index}_${item.id}`,
                    class: vue.normalizeClass(["divide-x divide-y last:border-b-0 px-2 py-1.5 text-left border hover:bg-gray-400/50", `${index % 2 ? 'bg-gray-300/50' : 'bg-gray-100/50'}`]),
                    onClick: $event => (rowClicked(item))
                  }, [
                    (__props.enableCheck)
                      ? (vue.openBlock(), vue.createElementBlock("td", {
                          key: `check_${item.label}`,
                          class: vue.normalizeClass(`px-2 py-1.5 align-top table-cell last:border-b-0 ${checkSelectedForRow(item) ? __props.rowSelectClass || 'bg-gray-400/50' : ''}`)
                        }, [
                          vue.withDirectives(vue.createElementVNode("input", {
                            ...
                            value: item,
                            type: "checkbox",
                            onClick: vue.withModifiers($event => (emit('checkRow', item)), ["stop"])
                          }, null, 8 /* PROPS */, _hoisted_23), [
                            [vue.vModelCheckbox, selectedRows.value]
                          ])
                        ], 2 /* CLASS */))
                      : vue.createCommentVNode("v-if", true),
                    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.fields, (field) => {
                      return (vue.openBlock(), vue.createElementBlock("td", {
                        key: field.key,
                        class: vue.normalizeClass(["px-2 py-1.5 align-top table-cell last:border-b-0", `${field.tdClass ?? ''} ${checkSelectedForRow(item) ? __props.rowSelectClass || 'bg-gray-400/50' : ''}`]),
                        style: vue.normalizeStyle(field.tdStyle)
                      }, [
                        vue.renderSlot(_ctx.$slots, `cell:${field.key || field.label}`, {
                          item: item,
                          data: getField(item, field.key),
                          toggleDetails: toggleDetails
                        }, () => [
                          vue.createTextVNode(vue.toDisplayString(getField(item, field.key, '')), 1 /* TEXT */)
                        ])
                      ], 6 /* CLASS, STYLE */))
                    }), 128 /* KEYED_FRAGMENT */))
                  ...
                  (item._showDetails)
                    ? (vue.openBlock(), vue.createElementBlock("tr", {
                        key: 0,
                        class: vue.normalizeClass(index % 2 ? 'bg-gray-300/50' : 'bg-gray-100/50')
                      }, [
                        vue.createElementVNode("td", {
                          colspan: __props.enableCheck ? __props.fields.length + 1 : __props.fields.length
                        }, [
                          vue.renderSlot(_ctx.$slots, "row-details", { item: item })
                        ], 8 /* PROPS */, _hoisted_24)
                      ], 2 /* CLASS */))
                    : vue.createCommentVNode("v-if", true)
                ], 64 /* STABLE_FRAGMENT */))
        ...
        vue.createElementVNode("tfoot", _hoisted_25, [
          (vue.unref(slots)['footer-row'])
            ? vue.renderSlot(_ctx.$slots, "footer-row", { key: 0 })
            : vue.createCommentVNode("v-if", true)
        ])
      ], 512 /* NEED_PATCH */)
    ]),
    (vue.unref(localTotalRows) > __props.perPage && !__props.hidePagination)
      ? (vue.openBlock(), vue.createBlock(script$1, {
          ...
          "total-rows": vue.unref(localTotalRows),
...
exports.TVPagination = script$1;
exports.TVTable = script;
